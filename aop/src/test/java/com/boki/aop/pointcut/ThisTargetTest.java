...
public class ThisTargetTest {
    ...
    static class ThisTargetAspect {
        ...
        // 부모 타입 허용
        @Around("this(com.boki.aop.member.MemberService)")
        ...
        // 부모 타입 허용
        @Around("target(com.boki.aop.member.MemberService)")
        ...
        @Around("this(com.boki.aop.member.MemberServiceImpl)")
        ...
        @Around("target(com.boki.aop.member.MemberServiceImpl)")
